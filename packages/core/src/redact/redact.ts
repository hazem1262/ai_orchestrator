...
export const REDACTION_PATTERNS: ReadonlyArray<RedactionPattern> = [
  ...
  { kind: 'github', source: '\\bgithub_pat_[A-Za-z0-9_]{20,}\\b', flags: 'g', replace: () => tag('github') },
  { kind: 'anthropic', source: '\\bsk-ant-[A-Za-z0-9_-]{10,}', flags: 'g', replace: () => tag('anthropic') },
  { kind: 'openai', source: '\\bsk-[A-Za-z0-9_-]{20,}', flags: 'g', replace: () => tag('openai') },
  { kind: 'slack', source: '\\bxox[abposr]-[A-Za-z0-9-]{6,}', flags: 'g', replace: () => tag('slack') },
  { kind: 'aws', source: '\\b(?:AKIA|ASIA)[0-9A-Z]{16}\\b', flags: 'g', replace: () => tag('aws') },
  {
    kind: 'credentials',
    source:
  ...
  { kind: 'gcp', source: '\\bAIza[0-9A-Za-z_-]{35}\\b', flags: 'g', replace: () => tag('gcp') },
  { kind: 'npm', source: '\\bnpm_[A-Za-z0-9]{36}\\b', flags: 'g', replace: () => tag('npm') },
  { kind: 'linear', source: '\\blin_api_[A-Za-z0-9]{20,}\\b', flags: 'g', replace: () => tag('linear') },
];
